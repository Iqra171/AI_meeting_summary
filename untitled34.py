!pip install -q transformers datasets pydub torchaudio
...
# Hugging Face Key (optional for private models)
os.environ["HF_TOKEN"] = ""
...
result = extract_summary_bullets_actions(full_transcript)
print(result)
